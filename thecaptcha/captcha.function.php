...
2. Include this file in your project with 'include()' or 'require()' statement. Example: if you plan to use captcha in file 'myform.php' place in the very first lines of the file this:
include("PATH_TO_CAPTCHA_DIRECTORY/captcha.function.php");
Dont't forget to change PATH_TO_CAPTCHA_DIRECTORY to the real path to these CAPTCHA scripts.

3. Place a call for CAPTCHA image in the form you want to protect: <img src="/captcha/captcha.image.php">
