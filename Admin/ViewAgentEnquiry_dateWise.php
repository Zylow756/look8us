...
&nbsp;</h1>
					...
					<b><font size="2"><a href="ViewAgentFollow_dateWise.php">
					Click for Follow up date wise &gt;&gt;</a></font></b>&nbsp;		
<form name="frmhlp" id="frmhlp" method="post" action="viewAgentEnquiry_dateWise.php" >
	...
	<table border="0" width="100%" id="table4" style="border-collapse: collapse" height="70">
						<tr>
							...
							<font size="2">From Enquiry Date </font></b></font></td>
							<td width="372">
...
<A HREF="#" onClick="cal.select(document.forms['frmhlp'].tdate0,'anchor2','dd-MM-yyyy'); return false;"  NAME="anchor2" ID="anchor2">
	...
	&nbsp;</td>
						...
						<tr>
							...
							<font size="2">Upto Enquiry Date</font></b></font></td>
							<td width="426">
...
<?php						
		...
		$i=1;
				while ($d<= $diff)
				{
						...
						$st="Select eid, edate,ename,cate,agenquiry.mobile as mobile,email,cdate,aname,estatus from agenquiry,agent  where agenquiry.aid=agent.aid and edate='".$d3."' order by eid desc";
						...
						//$num_rows = mysql_num_rows($result);
							...
							?>				<tr>
									...
									<td height="29" width="23%">&nbsp;<?php echo $row["ename"]; ?></td>
									<td height="29" width="13%">&nbsp;<?php echo $row["cate"]; ?></td>
									<td height="29" width="10%">&nbsp;<?php echo $row["mobile"]; ?></td>
