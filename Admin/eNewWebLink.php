...
$st="insert into eweblink values (NULL ,". $_POST["cate"]. ",'". $_POST["wname"]. "','". $_POST["wlink"]. "','". $_POST["address"]. "','". $_POST["city"]. "','". $_POST["mobile"]. "','0')" ;
mysql_query($st,$con);
//echo $st;
$msg=1;
		...
		<tr>
			...
			<table border="0" width="100%" id="table2" style="border-collapse: collapse" bordercolor="#CCCCCC" height="206" cellpadding="0">
				<tr>
					...
					<p>
					<h3><?php if ($msg==1) echo "E-Commerce Link Add Successfully."; ?>
...
<tr>
	...
	<select name="cate" class="selbox" id="cate">
	...
	<option value="<?php echo $row['ecateid']; ?>"><?php echo $row["catename"]; ?> </option>
			<?php
...
<tr>
	...
	<input  class="txtbox" type="text" name="wname" id="cname3" tabindex="4"  size="1"/></td>
</tr>
...
<tr>
	...
	<input  class="txtbox" type="text" name="wlink" id="cname2" tabindex="4"  size="1"/></td>
</tr>
