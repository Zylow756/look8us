...
<div align="center">
	<table border="0" width="980" id="table1" style="border-collapse: collapse" bordercolor="#E2E2E2" cellpadding="0">
		...
		?>
			...
			<form name="frmhlp" id="frmhlp" method="post" action="ViewDetail.php" >
...
<textarea name="remark" rows="10" cols="64" ><?php  echo $row['remark'];  ?></textarea>
	</td>
	</tr>
...
<textarea name="remark0" rows="10" cols="64" ><?php  echo $row['remark1'];  ?></textarea>
</td>
	</tr>
...
<tr><td width="295" height="28" align="right">Password </td>
	...
	<input  class="txtbox" type="text" name="pass" id="pass" tabindex="3" value="<?php echo $pass;  ?>"  size="1"/></td>
