...
&nbsp;<table border="0" width="350" id="table2" height="333" background="img/login.png" style="border-collapse: collapse">
						<tr>
							<td><form action="home1.php" method="post"> 
							<table border="0" class="table4" width="99%" id="table4" style="border-collapse: collapse" height="227">
								...
								<tr>
									...
									<input type="text" name="t1" id="t1"  class="txtbox" size="27" autocomplete="username" onfocus="if(this.value=='Your User Name'){this.value='';}" onblur="if(this.value==''){this.value='Your User Name';}" required >  </td>
								</tr>
								<tr>
									<td width="7%" height="24">&nbsp;</td>
									<td width="26%" height="24">
									<font color="#333333" size="2">Password</font></td>
									<td height="24" width="65%"><input type="password" name="t2" class="txtbox1" autocomplete="current-password" required >  </td>
								</tr>
								<tr>
