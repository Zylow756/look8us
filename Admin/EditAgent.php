...
$s="UPDATE agent SET aname = '". $_POST['aname']."', address='". $_POST['address']."',mobile = '". $_POST['mobile']."',pass = '". $_POST['pass']."' where aid=".$_POST['aid'] ;
//echo $s;
mysql_query($s,$con);
$msg=1;
...
$s="delete from agent  where aid=".$_POST['aid'] ;
//echo $s;
mysql_query($s,$con);
$msg=2;
...
?>
	...
	if (isset( $_GET["id"]))
	{
		$s="select * from agent where aid=". $_GET["id"] ;
	   $r=mysql_query($s,$con);
...
<tr>
	...
	&nbsp;<b><?php echo $row['acode']; ?></b></td>
</tr>
						

<tr>
	<td width="103" height="30">Agent Name
	<input  type="hidden" name="aid" id="aid" tabindex="4" value="<?php echo $row['aid']; ?>"  size="1"/>
	
	
	</td><td width="331" height="30">
	<input  class="txtbox" type="text" name="aname" id="cname" tabindex="4" value="<?php echo $row['aname']; ?>"  size="1"/></td>
</tr>
<tr>
...
<tr>
	...
	<input  class="txtbox" type="text" name="mobile" id="mobile" tabindex="4"  size="1" value="<?php echo $row['mobile']; ?>"/>
...
<tr>
	...
	<input  class="txtbox" type="text" name="pass" id="pass" tabindex="4"  size="1" value="<?php echo $row['pass']; ?>"/>
