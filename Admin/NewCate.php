...
<tr>
	...
	<input  class="txtbox" type="text" name="cname" id="cname" tabindex="4" value="Category Name" onfocus="if(this.value=='Category Name'){this.value='';}" onblur="if(this.value==''){this.value='Category Name';}" size="1"/></td>
</tr>
<tr>
...
<tr><td width="116" height="38">&nbsp;</td><td width="286" height="38">
	<input  class="subbox" type="submit" value="Submit" name="submit"/>
		...
		while ($row=mysql_fetch_array($result))
			...
			?>
								<tr>
									<td width="353">&nbsp;&nbsp;<?php echo $row["cname"]; ?></td>
								</tr>
