...
if (isset($_POST["submit"]))
{
		...
		$st="update ecate set catename='". $_POST["cname"]. "',remark='". $_POST["remark"]. "' where ecateid=". $_POST["id"] ;
		mysql_query($st,$con);
		//echo $st;
		$msg=1;
		...
		<tr>
			...
			<table border="0" width="100%" id="table2" style="border-collapse: collapse" bordercolor="#CCCCCC" height="206" cellpadding="0">
				<tr>
					...
					<p>
					<h3><?php if ($msg==1) echo "E-Commerce Category Update"; ?>
					<?php if ($msg==2) echo "Error : Please Check Image Format(Gif/JPG) or Size"; ?>
					<?php if ($msg==3) echo "E-Commerce Image Update"; ?>
...
elseif ( isset($_POST["id"]))
 $st="Select * from ecate where ecateid=".$_POST["id"];
...
$result=mysql_query($st,$con);
	...
	?>						
						...
						<form name="frmhlp" id="frmhlp" method="post" action="ViewECate.php" enctype="multipart/form-data">
						

<tr>
	<td width="116" height="42">Category Name<input  type="hidden" name="id"  value="<?php echo $row['ecateid']; ?>" size="1"/></td>
	<td width="385" height="42">
	<input  class="txtbox" type="text" name="cname" id="cname" tabindex="4" value="<?php echo $row['catename']; ?>"  size="1"/></td>
</tr>
<tr>
...
<tr>
	<td width="116" height="189">&nbsp;</td><td width="385" height="189">
		&nbsp;&nbsp;<img border="0" src="../user/logo/<?php echo $row['cateimg']; ?>" width="149" height="148"></td>
</tr>
<tr>
