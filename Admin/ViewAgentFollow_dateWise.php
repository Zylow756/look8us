...
&nbsp;</h1>
					...
					<b><font size="2"><a href="ViewAgentEnquiry_dateWise.php">
					Click for Feeding date wise &gt;&gt;</a></font></b>&nbsp;&nbsp;		
<form name="frmhlp" id="frmhlp" method="post" action="viewAgentFollow_dateWise.php" >
	...
	<input  class="subbox" type="submit" value="Show" name="submit"/></td>
					...
					<table class="table2"  width="99%" id="table3" border="1"    >
								<tr>
									...
									<td bgcolor="#D2D2D2" width="11%" style="text-align: center" height="33">
									Follow-up Date</td>
									<td bgcolor="#D2D2D2" width="20%" height="33">&nbsp; Company Name</td>
									<td bgcolor="#D2D2D2" width="13%" height="33">&nbsp;Contact Person</td>
									<td bgcolor="#D2D2D2" width="7%" height="33">Mobile</td>
