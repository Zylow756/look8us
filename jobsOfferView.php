	...
	?>						
						<table   width="94%" id="table5" border="0" style="border-collapse: collapse"    >
								<tr>
									...
									<p style="line-height: 150%; margin-left:5px; margin-right:5px; margin-top:5px">Post Date: <b> <?php echo $row["y"]; ?></b><br>Location : <?php echo $row["city"]; ?>
									...
									<table border="0" width="100%" id="table35" style="border-collapse: collapse">
										<tr>
											...
											<td height="25"><b><?php echo $row["cate"]; ?></b></td>
										</tr>
										<tr>
											<td width="24" height="25">&nbsp;</td>
											<td height="25"><b><font size="2"><?php echo $row["atitle"]; ?></font></b></td>
										</tr>
										<tr>
											<td width="24" height="25">&nbsp;</td>
											<td height="25"><font size="2"><?php echo $row["discr"]; ?></font></td>
										</tr>
										<tr>
											<td width="24" height="25"></td>
											<td height="25"><font size="2"><?php echo $row["jtype"]; ?></font></td>
										</tr>
										<tr>
											<td width="24" height="25"></td>
											<td height="25"><font size="2">Rs.<?php echo $row["srange"]." ".$row["stype"]; ?></font></td>
										</tr>
										<tr>
											<td width="24" height="25"></td>
											<td height="25"><font size="2"><?php echo $row["city"]; ?></font></td>
										</tr>
									</table>
									</td>
									<td width="9%">
									&nbsp;<a class="a5" href="viewJobDetail.php?id=<?php echo $row['jid']; ?>" >View</a></td>
								</tr>
