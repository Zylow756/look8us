...
// =============Save request============================================
// $txnid , firstname, email,phone, pid ,productinfo,amount ,rdate
//mihpayid, addedon,status,txnid,amount,email
...
setTimeout('document.payuForm.submit();',5);
</script>
   ...
   <div style="display: none;">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td>Amount: 
			<input name="pid" value="<?php echo (empty($posted['pid'])) ? '' : $posted['pid'] ?>" size="9" /></td>
