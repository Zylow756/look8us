		...
		<tr>
			...
			<table border="0" width="100%" id="table2" style="border-collapse: collapse" bordercolor="#CCCCCC" height="206" cellpadding="0">
				<tr>
					...
					<p><h3><?php if ($msg==1) echo "New Enquiry Create"; ?>
										</h3>
</p>
...
<tr>
	...
	<input  class="txtbox" type="text" name="aname" id="aname" tabindex="4" onfocus="if(this.value=='Enquiry Name'){this.value='';}" onblur="if(this.value==''){this.value='Enquiry Name';}" value="Enquiry Name" size="24"/></td>
</tr>
<tr>
	<td width="104" height="40">Contact Person/<br>
	Qualification</td><td width="231" height="40">
	<input  class="txtbox" type="text" name="cate" id="cate" tabindex="4"  size="24"/></td>
</tr>
<tr>
	<td width="104" height="40">Address</td><td width="231" height="40">
	<input  class="txtbox" type="text" name="address" id="address" tabindex="4"  size="1"/></td>
</tr>
<tr><td width="104" height="28">Area</td><td width="231" height="28">
	<input  class="txtbox" type="text" name="area" id="address0" tabindex="4"  size="1"/></td>
	</tr>
<tr><td width="104" height="28">City</td><td width="231" height="28">
	<input  class="txtbox" type="text" name="city" id="city" tabindex="4"  size="1"/></td>
	</tr>
<tr><td width="104" height="37">Mobile-1</td><td width="231" height="37">
	<input  class="txtbox" type="text" name="mobile" id="mobile" tabindex="4"  size="1"/></td>
	</tr>
<tr><td width="104" height="44">Email/ Mobile-2</td><td width="231" height="44">
	<input  class="txtbox" type="text" name="email" id="email" tabindex="4"  size="1"/></td>
	</tr>
<tr><td width="104" height="39">Website</td><td width="231" height="39">
	<input  class="txtbox" type="text" name="web" id="email0" tabindex="4"  size="1"/></td>
	</tr>
<tr><td width="104" height="97">&nbsp;</td><td width="231" height="97">
