...
?>	
	...
	<?php
	$i=1;
	while ( ($row=mysql_fetch_array($result))&&($i<$rno)&&($i<28))
	{	
?>
...
<ul id="scroller">
  ...
  <li><a href="http://<?php  echo $row['website'] ; ?>" target="_blank" class="a5">
	<img border="1" src="user/logo/<?php  echo $row['img'] ; ?>" width="240" height="145"><?php  echo $row['aname'] ; ?>
	</a>
	</li>
