			...
			<table border="0" width="100%" id="table2" style="border-collapse: collapse" bordercolor="#CCCCCC" height="206" cellpadding="0">
				<tr>
					...
					<table class="table3" border="0" width="99%"  id="table4" cellpadding="0" style="border-collapse: collapse" bordercolor="#697779">
						<form name="frmhlp" id="frmhlp" method="post" action="Addlogo.php" enctype="multipart/form-data" >



<tr>
	<td width="15%" height="35" bgcolor="#FFFFFF" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; text-align:right" valign="top">&nbsp;<p>Select logo Image&nbsp;<br>
&nbsp;</p>
	<p>&nbsp;</td>
	<td width="49%" height="35" bgcolor="#FFFFFF" colspan="2" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; " valign="top">
&nbsp;<p>
<input type="file" name="photoimg"   id="photoimg" size="38"/></p>
<p><font color="#FF0000"><b>&nbsp;Logo/Image&nbsp; file should be JPG/GIF , Max 
100*100 Pixel</b></font> </td>
	<td width="36%" bgcolor="#FFFFFF" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; text-align:center" rowspan="2">
		...
		<p style="text-align: center"><u><font color="#FF0000"><b>Current Logo</b></font></u></p>
		<p>
...
if (!$result) {
    die(mysqli_error($con));
		...
		if ($row=mysqli_fetch_assoc($result))
			...
			{
			?>
				<img border="1" src="<?php echo "logo/".$row['logo']; ?>"  width="164" height="166">
		...
		?>
		<img border="1" src="logo/nologo.jpg">
...
<tr><td width="15%">&nbsp;</td><td width="34%" height="55" valign="top">
	<input  class="subbox" type="submit" value="Upload Logo" name="submit"  onclick="return vfhfn();"/></td>
	<td width="16%">
	&nbsp;</td></tr>
