...
<tr>
	...
	<input class="txtbox" type="text" name="compname" id="compname" tabindex="1" value="<?php if (isset($_POST['compname'])) echo $_POST['compname']; else echo 'Company Name';  ?>"  onfocus="if(this.value=='Company Name'){this.value='';}" onblur="if(this.value==''){this.value='Company Name';}" size="1"/></td>
	<td height="35" width="381">
	&nbsp;</td>
				</tr>
<tr><td width="396" height="35" align="right"><font color="#333333">Owner/Contact Person </font></td>
	<td width="233" height="35" align="center">
	<input class="txtbox" type="text" name="mname" id="mname" tabindex="2" value="<?php if (isset($_POST['mname'])) echo $_POST['mname']; else echo 'Member Name';  ?>" onfocus="if(this.value=='Member Name'){this.value='';}" onblur="if(this.value==''){this.value='Member Name';}" size="1"/></td>
	<td height="35" width="381">
	&nbsp;</td>
				</tr>
<tr>
	...
	<td width="233" height="35" align="center">
	<input  class="txtbox" type="text" name="city" id="city" tabindex="3" value="<?php if (isset($_POST['city'])) echo $_POST['city']; else echo 'City';  ?>" onfocus="if(this.value=='City'){this.value='';}" onblur="if(this.value==''){this.value='City';}" size="1"/></td>
...
<tr>
	...
	<td width="233" height="35" align="center">
	<input  class="txtbox" type="text" name="mobile" id="mobile" value="<?php if (isset($_POST['mobile'])) echo $_POST['mobile'];  else echo 'Mobile';  ?>" onfocus="if(this.value=='Mobile'){this.value='';}" onblur="if(this.value==''){this.value='Mobile';}" tabindex="4" size="1"/></td>
	<td height="35" valign="top" width="381">
	&nbsp;</td>
</tr>
<tr>
	...
	<td width="233" height="35" align="center">
	<input class="txtbox" type="text" name="txtmail" id="txttmail" value="<?php if (isset($_POST['txtmail'])) echo $_POST['txtmail'];   else echo 'Email ID';  ?>" onfocus="if(this.value=='Email ID'){this.value='';}" onblur="if(this.value==''){this.value='Email ID';}" tabindex="5" /></td>
	<td height="35" valign="top" width="381">
